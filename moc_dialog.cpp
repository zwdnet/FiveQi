...
**
** Created: Fri Oct 7 21:35:26 2011
...
int SelectDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: bAlgorithmChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: wAlgorithmChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: OK(); break;
        case 3: currentTimesChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
